package com.inventrik.integration.shopee.util;
 ...
 *   <li><b>Shop API:</b>   {@code partnerId + apiPath + timestamp + accessToken + shopId}</li>
 *   <li><b>Merchant API:</b> {@code partnerId + apiPath + timestamp + accessToken + merchantId}</li>
 * </ul>
 */
public final class ShopeeSignatureUtil {
    ...
    /**
     * Generate signature for a <b>public</b> Shopee API call (no access token required).
     */
