...
import com.inventrik.shopee.model.auth.ShopeeTokenRequest;
import com.inventrik.shopee.model.auth.ShopeeTokenResponse;
...
public class ShopeeAuthService {
    ...
    public ShopeeTokenInfo getAccessToken(String authCode, long shopId) {
        ...
        ShopeeTokenRequest requestBody = new ShopeeTokenRequest();
        requestBody.setCode(authCode);
        requestBody.setShopId(shopId);
        requestBody.setPartnerId(ShopeeConfig.PARTNER_ID);
    ...
    public ShopeeTokenInfo refreshAccessToken(long shopId) {
        ...
        ShopeeTokenRequest requestBody = new ShopeeTokenRequest();
        requestBody.setRefreshToken(existingToken.getRefreshToken());
        requestBody.setShopId(shopId);
        requestBody.setPartnerId(ShopeeConfig.PARTNER_ID);
